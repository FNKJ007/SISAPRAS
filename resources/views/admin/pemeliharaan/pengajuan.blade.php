...
<div class="space-y-6" x-data="pengajuanAdminModal()">
    ...
    <div x-show="modalOpen"
        ...
        <div class="custom-scrollbar admin-modal-dialog" style="background:#FFFFFF; border-radius:16px; width:100%; max-width:540px; max-height:88vh; overflow-y:auto; overflow-x:hidden; box-shadow:0 20px 40px -10px rgba(0,0,0,0.25); border:1px solid #E2E8F0; margin:auto; text-align:left;">
