...
<div x-data="{
    ...
    <div style="background:#FFFFFF; border-radius:16px; border:1px solid #E2E8F0; box-shadow:0px 18px 40px rgba(112,144,176,0.08); overflow:hidden;">
            ...
            <div style="padding:56px 20px; text-align:center; background:#FFFFFF; display:flex; flex-direction:column; align-items:center; justify-content:center;">
                ...
                @if(!empty($searchQuery))
                    ...
                    <div style="font-size:13px; color:#64748B; margin-bottom:18px; max-width:440px; margin-left:auto; margin-right:auto;">
                        Tidak ditemukan data pegawai dengan kata kunci "<strong>{{ $searchQuery }}</strong>".
                    </div>
        ...
        @else
            <div style="overflow-x:auto; -webkit-overflow-scrolling:touch;">
                <table style="width:100%; min-width:750px; border-collapse:collapse; font-size:13px; text-align:left;">
                    <thead>
                            ...
                            <tr style="border-bottom:1px solid #F1F5F9; transition:background 0.15s;" onmouseover="this.style.background='#F8FAFC'" onmouseout="this.style.background='transparent'">
                                ...
                                <td style="padding:14px 16px; text-align:center;">
                                    <div style="display:inline-flex; align-items:center; gap:6px;">
                                        ...
                                        {{-- Tombol Kelola Akun --}}
                                        <a href="{{ route('admin.pengaturan', ['search' => $item->nip ?: $item->name]) }}"
                                           style="padding:6px 9px; background:#F8FAFC; border:1px solid #CBD5E1; border-radius:8px; color:#059669; cursor:pointer; font-size:12px; transition:all 0.15s; display:inline-flex; align-items:center;"
                                           title="Kelola / Buat Akun Login">
                                            <i data-lucide="key-round" style="width:14px; height:14px; color:#059669;"></i>
                                        </a>
    ...
    <div x-show="createModalOpen" style="display:none; position:fixed; inset:0; z-index:9999; overflow-y:auto; background:rgba(15,23,42,0.6); backdrop-filter:blur(4px);"
        ...
        <div style="min-height:100vh; display:flex; align-items:center; justify-content:center; padding:16px;">
            <div @click.away="createModalOpen = false" style="background:#FFFFFF; border-radius:20px; max-width:500px; width:100%; box-shadow:0 25px 50px -12px rgba(0,0,0,0.25); overflow:hidden;">
                <div style="padding:20px 24px; background:#0F172A; color:#FFFFFF; display:flex; align-items:center; justify-content:space-between;">
                    <div style="display:flex; align-items:center; gap:10px;">
                        ...
                        <div>
                            ...
                            <p style="font-size:11.5px; color:#94A3B8; margin:2px 0 0 0;">Data identitas, NIP &amp; jabatan dinas</p>
                        </div>
                    </div>
    ...
    <div x-show="editModalOpen" style="display:none; position:fixed; inset:0; z-index:9999; overflow-y:auto; background:rgba(15,23,42,0.6); backdrop-filter:blur(4px);"
         ...
         x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
        <div style="min-height:100vh; display:flex; align-items:center; justify-content:center; padding:16px;">
            <div @click.away="editModalOpen = false" style="background:#FFFFFF; border-radius:20px; max-width:500px; width:100%; box-shadow:0 25px 50px -12px rgba(0,0,0,0.25); overflow:hidden;">
                <div style="padding:20px 24px; background:#1E3A8A; color:#FFFFFF; display:flex; align-items:center; justify-content:space-between;">
                    <div style="display:flex; align-items:center; gap:10px;">
                        ...
                        <div>
                            ...
                            <p style="font-size:11.5px; color:#94A3B8; margin:2px 0 0 0;">Perbarui nama, NIP, atau jabatan dinas</p>
                        </div>
                    </div>
