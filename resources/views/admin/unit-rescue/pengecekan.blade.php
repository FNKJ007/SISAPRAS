...
<div class="admin-pengecekan-wrapper" x-data="pengecekanRescueAdmin('{{ $tab }}')">
    ...
    <div style="margin-bottom:18px;">
        <form method="GET" action="{{ route('admin.unit-rescue.pengecekan') }}" style="display:flex; align-items:center; gap:8px; width:100%; max-width:520px;">
            ...
            @if(!empty($searchQuery))
                <a href="{{ route('admin.unit-rescue.pengecekan') }}?tab={{ $tab }}" style="padding:8px 12px; background:#F1F5F9; color:#64748B; border:1px solid #CBD5E1; border-radius:10px; font-size:12px; font-weight:600; text-decoration:none;">
                    Reset
                </a>
            @endif
        </form>
