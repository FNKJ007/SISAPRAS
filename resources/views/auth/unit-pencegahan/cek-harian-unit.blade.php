...
<div class="daily-check-unit bg-white rounded-xl shadow-sm p-4 sm:p-6 max-w-4xl mx-auto" id="wizardCekHarianUnit">
    ...
    <form action="{{ route('unit-pencegahan.cek-harian-unit.store') }}" method="POST" enctype="multipart/form-data" id="formCekHarianUnit" class="space-y-6">
        ...
        <div data-step-panel="3" class="hidden">
            <div class="mb-4 p-4 rounded-xl border border-emerald-100 bg-emerald-50/60"><h2 class="font-bold text-base text-gray-900">Pemeriksaan Perlengkapan Kendaraan</h2><p class="text-xs text-gray-600 mt-1">Periksa setiap item satu per satu. Pilih kondisi dan tambahkan catatan bila diperlukan.</p></div>
