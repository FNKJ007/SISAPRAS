...
<div class="daily-check-unit bg-white rounded-xl shadow-sm p-4 sm:p-6 max-w-4xl mx-auto" id="wizardCekHarianUnit">
    ...
    <form action="{{ route('unit-pencegahan.cek-harian-unit.store') }}" method="POST" enctype="multipart/form-data" id="formCekHarianUnit" class="space-y-6">
        ...
        <div data-step-panel="3" class="hidden">
            <div class="mb-4 p-4 rounded-xl border border-emerald-100 bg-emerald-50/60"><h2 class="font-bold text-base text-gray-900">Pemeriksaan Kendaraan</h2><p class="text-xs text-gray-600 mt-1">Periksa setiap item satu per satu. Pilih kondisi dan tambahkan catatan bila diperlukan.</p></div>
        ...
        <div data-step-panel="4" class="hidden unit-confirmation-panel">
            ...
            <div class="border border-gray-200 rounded-xl divide-y divide-gray-200">
                @foreach(['Identitas Pemeriksaan', 'Pemanasan & BBM', 'Kendaraan'] as $ringkasan)
...
(function () {
    ...
    // Dynamic Filter Unit Kendaraan Pencegahan berdasarkan Pos yang dipilih
    ...
    if (posSelect) {
        posSelect.addEventListener('change', function () {
            ...
            if (unitSelect) {
                ...
                unitSelect.innerHTML = '<option value="" disabled selected>Pilih Unit / Kendaraan Pencegahan</option>';
